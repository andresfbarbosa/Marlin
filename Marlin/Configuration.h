...
#define DEFAULT_E_STEPS_PER_UNIT (((MOTOR_STEPS_PER_REV_AXIS_E * DRIVER_MICROSTEPS_AXIS_E) * (E_GEAR_RATIO) / (E_HOB_EFFECTIVE_DIAMETER * PI )) / DEFAULT_E_STEPS_CALIBRATION_FACTOR)
